          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center text-gray-600">
              ...
              <div>
                ...
                <p className="text-sm sm:text-md font-medium">{user.name}</p>
                <p className="text-sm sm:text-md text-gray-500 truncate w-36 sm:w-full">
                  {user.email}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center text-gray-600 break-all">
              <IdCard
                className={`h-8 w-8 sm:w-5 sm:h-5 mr-3 ${ticket.event.is_cancelled ? "text-red-600" : "text-blue-600"}`}
              />
              <div>
                <p className="text-xs sm:text-sm text-gray-500">
                  Ticket Holder ID
                </p>
                <p className="text-sm sm:text-md font-medium">{user.userId}</p>
              </div>
            </div>
            ...
            <div className="flex items-center text-gray-600">
              ...
              />
              <div>
                <p className="text-xs sm:text-sm text-gray-500">Ticket Price</p>
                <p className="text-sm sm:text-md font-medium">
